...
class OrderDaoSpec extends Specification {
  ...
  "The OrderDao" should {
    ...
    "add a order to history" in memDB {
      OrderDao.addToHistory(OrderHistory(-1, -20, "Susanne Emil, Ulrichstr. 1, 82343 Pöcking", "1x Margarita (medium)", 6.21, "20.05.2017", "in Bearbeitung")) must be_!==(null)
    }
