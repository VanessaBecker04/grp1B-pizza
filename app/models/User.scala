...
/**
  ...
  */
case class User(var id: Long, var forename: String, var name: String, var address: String, var zipcode: Int, var city: String, var role: String, var inactive: Boolean)
